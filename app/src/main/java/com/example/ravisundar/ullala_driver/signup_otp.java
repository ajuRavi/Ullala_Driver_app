...
public class signup_otp extends AppCompatActivity {
    ...
    String code, verificationid, username, type, number, vehiclenumber;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vehiclenumber = extras.getString("vehiclenumber");
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
        ...
        public void onVerificationFailed(FirebaseException e) {
            Toast.makeText(signup_otp.this, number, Toast.LENGTH_LONG).show();
                ...
                .addOnCompleteListener(signup_otp.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Driver_signup signup=new Driver_signup(username,number,vehiclenumber,type,latitude1,longitude1);
